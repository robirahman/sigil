...
function main() {
	...
	tutorialtext3 =
		"A physical version of Sigil will<br>be launching soon on Kickstarter.<br>Check the <a href='https://www.pineislandgames.com' target='_blank' rel='noopener noreferrer'>Pine Island Games website</a><br>for details, and join our mailing list for updates.";

	tutorialtext4 = 'Overview of sigilbattle.com Features';

	tutorialtext5 =
		'At sigilbattle.com you can play Sigil online<br>for free. Learn the rules<br>in this tutorial, then try out a<br>single-player game against an AI.';

	tutorialtext6 =
		'If you want to play against a friend,<br>you can create a private game<br>for them to join.';

	tutorialtext7 =
		'If you want to compete against random<br>opponents, you can play games on the ladder.<br>Wins and losses in ladder games will affect<br>your Sigil rating. The highest rated players<br>are visible on the leaderboard,<br>and in the future they may be invited to<br>exclusive Sigil tournaments<br>with cash prizes.';

	tutorialtext8 = 'How to Play';

	tutorialtext9 =
		"Sigil is a battle between the red stones and blue stones.<br>Each side is trying to expand their territory<br>and disrupt the opponent's expansion.";

	tutorialtext10 =
		'As your stones expand<br>to different regions of the board,<br>you gain different special<br>abilities; these are called spells.';
	...
	tutorialtext16 =
		"The red circle in the bottom<br>left is red's starting location.<br>Blue starts with a stone<br>in the bottom right.";
	...
	tutorialtext19 =
		"The small white circles are called<br>nodes. Stones are placed<br>inside of nodes. There are also three<br>special mana nodes around the edge<br>of the board: the red and blue starting<br>locations, and one more 'neutral' mana<br>at the top of the board.";
