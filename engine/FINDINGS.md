...
| `tact_ext` 41 (crush only; cap 1) vs 0 | `20260923T014810Z` | 1,408 | 45.45% [42.87, 48.06] | **-31.7 [-49.9, -13.5]** | 1.000 |
| `singular` 150 vs 0 | `20260923T005416Z` | 1,408 | 51.14% [48.53, 53.74] | **+7.9 [-10.2, +26.0]** | 1.000 |
...
fallback loses too (-31.7): extending even one ply on a crush costs more than the horizon it buys. `singular` reads +7.9 with a lower bound of -10.2: no measured difference at 10 s (as expected for a
feature that touches only depth >= 4 PV nodes), stays OFF pending a longer-clock arena. `lmr_quiet` loses, as the class-staged stream predicted ("late quiet" is a low-ranked first move, not a late
move): **stays OFF**.
