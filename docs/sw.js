...
const SAME_ORIGIN_PRECACHE = [
	...
	'./static/scripts/game-board-local.js?v=11',
	'./static/scripts/engine/rust-ai.js?v=11',
	...
	'./static/scripts/engine/rust-worker.js?v=11',
	'./static/wasm/sigil_engine.js?v=11',
	'./static/wasm/sigil_engine_bg.wasm?v=11',
