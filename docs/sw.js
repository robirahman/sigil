...
const SAME_ORIGIN_PRECACHE = [
	...
	'./static/scripts/game-board-local.js?v=15',
	'./static/scripts/engine/rust-ai.js?v=15',
	...
	'./static/scripts/engine/rust-worker.js?v=15',
	'./static/wasm/sigil_engine.js?v=15',
	'./static/wasm/sigil_engine_bg.wasm?v=15',
