...
| **Flood** | rich sapphire blue | **Tsunami**: crashing ocean waves with whitecaps<br>**Torrent**: cascading waterfall splitting into splashes<br>**Splash**: liquid crown splash with droplets rising up |
